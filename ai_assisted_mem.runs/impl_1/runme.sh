...
HD_PWD='C:/Users/Devansh Sharma/Code/Projects/ai_assisted_mem/ai_assisted_mem.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ai_memory_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ai_memory_top.tcl -notrace

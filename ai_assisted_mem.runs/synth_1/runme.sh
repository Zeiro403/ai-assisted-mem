...
HD_PWD='C:/Users/Devansh Sharma/Code/Projects/ai_assisted_mem/ai_assisted_mem.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ai_memory_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ai_memory_top.tcl
